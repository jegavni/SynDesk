...
const SidebarHeader = ({ onOpenGroup, onOpenSettings, onOpenInvite }: SidebarHeaderProps) => (
  <div style={{ padding: '1.5rem', borderBottom: '1px solid var(--border-color)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
    ...
    <div style={{ display: 'flex', gap: '0.4rem', alignItems: 'center' }}>
      ...
      <button
        onClick={onOpenGroup}
        style={{ padding: '0.4rem', backgroundColor: 'var(--border-color)', color: 'white', border: 'none', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', width: '32px', height: '32px', cursor: 'pointer', flexShrink: 0 }}
        title="New Group"
      >
      ...
      <button
        ...
        style={{ padding: '0.4rem 0.75rem', fontSize: '0.8rem', display: 'flex', alignItems: 'center', gap: '0.4rem', backgroundColor: 'var(--border-color)', color: 'white', border: 'none', borderRadius: 'var(--radius-full)', cursor: 'pointer', flexShrink: 0 }}
