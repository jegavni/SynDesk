    ...
    <div style={{ padding: '1rem 1.5rem', backgroundColor: 'var(--surface-color)', borderTop: '1px solid var(--border-color)' }}>
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
        ...
        <label
          ...
          style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0.75rem', borderRadius: '50%', backgroundColor: 'var(--bg-color)', color: 'var(--text-secondary)', transition: 'color 0.2s', flexShrink: 0 }}
          title="Attach a file"
        >
